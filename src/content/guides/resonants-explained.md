...
## Beating one rewards an ability

This is the key hook: defeating a Resonant **grants Dylan a new combat ability**. So bosses aren't just obstacles — they're the primary way you expand your kit. Your power curve is paced against them, which means build decisions and boss fights feed into each other throughout the game.
...
Because abilities flow from bosses, the Resonants effectively author your options. Plan around them:
